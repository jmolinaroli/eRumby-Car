...
void UpdateMotori()
{
  ...
  if (pinDataRicevente[1].pulseWidth <= DUTY_MOTORE_NEUTRO_SAFE - 50)
  {
    comandoESC = map(pinDataRicevente[1].pulseWidth, DUTY_MOTORE_MIN, DUTY_MOTORE_MAX, DUTY_ESC_MAX_SAFE, DUTY_ESC_NEUTRO);
